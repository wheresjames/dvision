...
It lives here rather than beside the first panel that needed one because it is
not about any of them: `dsim`'s realism and sensor forms and `dnav`'s planning
side panel all outgrow their window on a small screen, and a second copy of a
wheel binding is how two windows come to scroll differently.
"""
